package com.elthisboy.neonix.list.enums;

import com.elthisboy.neonix.init.ItemInit;
import com.elthisboy.neonix.list.TagList;
...
public class NeoHoloNixModToolMaterials implements ToolMaterial {
   ...
   //);
    ...
    NeoHoloNixModToolMaterials(int durability, float miningSpeedMultiplier, float attackDamage, TagKey<Block> inverseTag, int enchantability, Ingredient repairIngredient) {
